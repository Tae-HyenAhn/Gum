...
public class TextureMovieEncoder implements Runnable {
    ...
    private static final int MSG_RESTART_RECORDING = 6;
    ...
    public void reStart(){
        ...
        mHandler.sendMessage(mHandler.obtainMessage(MSG_RESTART_RECORDING));
    }
    ...
    private void handleFrameAvailable(float[] transform, long timestampNanos) {
        ...
        //if(ratioState == TrimActivity.TrimDecodeRenderer.RATIO_CIRCLE){
        //    shader.setShader();
    ...
    private void prepareRect(){
        ...
        mRect.setScale(videoWidth*screenWidth/videoHeight, screenWidth);
    ...
    private void initEncodedDataList(){
        mVideoEncoder.initListItems();
    }
