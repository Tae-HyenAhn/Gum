...
import me.ggum.gum.encoder_export.AudioEncoderCore;
import me.ggum.gum.encoder_export.ExportMuxerWrapper;
import me.ggum.gum.encoder_trim.TrimMuxerWrapper;

/**
 * Created by sb on 2017. 1. 26..
 */

public class ExportAudioDecoder extends Thread {
    ...
    public void init(String path, long startTime, long endTime, ExportMuxerWrapper muxerWrapper){
        eosReceived = false;
        firstDecode = true;
            ...
            if(isInput){
                ...
                if (inIndex >= 0) {
                    ...
                    if (sampleSize > 0) {
                        ...
                        Log.d(TAG, startTime + ", " + presentationTimeUs);

                        mDecoder.queueInputBuffer(inIndex, 0, sampleSize, presentationTimeUs, 0);
                        /*
                        if (presentationTimeUs >= endTime * 1000) {
